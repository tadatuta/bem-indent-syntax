...
/* begin: ../../common.blocks/bem-indent-syntax/bem-indent-syntax.js */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.bis = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
module.exports = {
...
},{"./lib/parse":2,"./lib/serialize":3,"./lib/stringify":4}],2:[function(require,module,exports){
'use strict';
...
},{"bem-naming":5}],3:[function(require,module,exports){
'use strict';
...
},{"bem-naming":5,"stringify-object":8}],4:[function(require,module,exports){
'use strict';
...
},{"./parse":2,"stringify-object":8}],5:[function(require,module,exports){
(function (global){
'use strict';
...
},{"is-plain-obj":6,"is-regexp":7}]},{},[1])(1)
});
/* end: ../../common.blocks/bem-indent-syntax/bem-indent-syntax.js */
    ...
    onInit: function() {
        ...
        this.bindTo('keydown', function(e) {
            if (e.keyCode === keyCodes.TAB) {
                ...
                textarea.setVal(val.substr(0, caret.start) + tab + val.substr(caret.start));
                control.setSelectionRange(caret.start + tab.length, caret.start + tab.length);
                e.preventDefault();
                return;
            }

            if (e.keyCode !== keyCodes.ENTER || !e.ctrlKey) return;

            e.preventDefault();

            var val = textarea.getVal(),
                newVal = bis[this._action](this._action === 'stringify' ? val : eval('(' + val + ')'));

            textarea.setVal(newVal);
            this.toggleAction();
        });
    },
